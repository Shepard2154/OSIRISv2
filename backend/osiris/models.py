...
class TwitterUserInfo(models.Model):
    ...
    profile_image_url = models.CharField(max_length=100, default=None, blank=True, null=True)
    description = models.CharField(max_length=160, default=None, blank=True, null=True)
    created_at = models.DateTimeField(default=timezone.now, blank=True, null=True)
    url = models.CharField(max_length=50, default=None, blank=True, null=True)
    location = models.CharField(max_length=50, default=None, blank=True, null=True)
    followers_count = models.PositiveIntegerField(default=0, blank=True, null=True)
    ...
    listed_count = models.PositiveIntegerField(default=0, blank=True, null=True)
...
class TwitterTweet(models.Model):
    ...
    original_screen_name = models.CharField(max_length=50) # имя процитированного, ретвитнутого, отвеченного пользователя

...
def v2_download_tweets_by_hashtag_and_limit(hashtag_item, limit=1000):
    scraper = twitter.TwitterHashtagScraper(hashtag_item)
    count = 0
...
def download_hashtags_from_file():
    ...
    hashtags_df = pd.read_excel('./backend/static/hashtags.xlsx', usecols=[0,2,4,6,8], na_filter=False)
